...
public class DBManager extends SQLiteOpenHelper{
    ...
    public void insertarPreguntas(SQLiteDatabase sqLiteDatabase) throws IOException {
        ...
        InputStream file = context.getResources().openRawResource(R.raw.questions);
    ...
    public Question[] obtenerPreguntas(String categoria, int numPreg) {
        ...
        Question[] preguntas = new Question[numPreg];
        int k = 0;
        while(!idPregsJuego.isEmpty()) {
            ...
            while(cu.moveToNext()) {
                ...
                Question preg = new Question(pregunta, resp1, resp2, resp3, respCorrecta);
                Log.d("Question", resp1);
                preguntas[k] = preg;
                k++;
            }
            cu.close();
    ...
    public Question[] obtenerPreguntasAleatorio(int numPreg) {
        SQLiteDatabase sqLiteDatabase = sInstance.getReadableDatabase();
